  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-[#ffe4ec] via-[#fff0f5] to-[#fce7f3] px-5 py-12 font-sans text-left antialiased">
      ...
      <div className="relative w-full max-w-md rounded-[1.85rem_2.2rem_2rem_1.9rem] border-2 border-dashed border-[#f9a8d4] bg-white p-8 text-center shadow-[8px_8px_0_0_rgba(190,24,93,0.12)] md:p-10">
        ...
        <div
          className="pointer-events-none absolute -right-1 top-8 h-12 w-20 rotate-[10deg] rounded-2xl bg-[#bbf7d0]/80 ring-1 ring-[#86efac]/50"
          aria-hidden
        />

        {/* Berry Icon */}
        <div className="mx-auto mb-5 flex h-28 w-28 items-center justify-center rounded-2xl border-2 border-[#fbcfe8] bg-[#fff0f6] shadow-[3px_3px_0_0_rgba(244,114,182,0.35)]">
        ...
        <p className="mt-2 font-craft text-sm text-[#db2777]">
          🍓 สดหวานทุกวัน 🫐
        </p>
